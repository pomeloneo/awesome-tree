import type { GetChildren, RawNode } from './interface';
...
export function isLeaf<R = RawNode, G = R, I = R>(rawNode: R | G | I, getChildren: GetChildren<R, G, I>): boolean {
...
export function isShallowLoaded<R = RawNode, G = R, I = R>(rawNode: R, getChildren: GetChildren<R, G, I>): boolean {
